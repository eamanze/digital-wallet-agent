...
export default function Page() {
  return (
    <>
      <header className="topbar"><div><h1 className="page-title">User operations</h1><p className="page-subtitle">View, suspend and manage users through audited maker-checker workflows.</p></div></header>
